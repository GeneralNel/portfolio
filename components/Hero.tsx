        ...
        >
          ...
          <div className="flex items-center gap-3">
            ...
            <MagneticButton href="#contact" strength={0.2}>
              <motion.div
                className="group flex items-center gap-2.5 rounded-full px-7 py-3.5"
              ...
              >
                <span
                  className="text-xs font-bold uppercase tracking-widest text-[--color-bg]"
                  style={{ fontFamily: "var(--font-mono)" }}
                >
                  Get in touch
                </span>
                <svg
                  className="h-3.5 w-3.5 text-[--color-bg] transition-transform duration-150 group-hover:translate-x-0.5"
            ...
            <MagneticButton href="/resume.pdf" strength={0.2} download>
              <motion.div
                className="group flex items-center gap-2 rounded-full border border-[rgba(255,255,255,0.15)] px-6 py-3.5 transition-colors duration-150 hover:border-[rgba(255,255,255,0.3)]"
                whileHover={{ scale: 1.03 }}
                whileTap={{ scale: 0.97 }}
                transition={{ duration: 0.15 }}
              >
                <svg
                  className="h-3.5 w-3.5 text-[--color-text-secondary] transition-transform duration-150 group-hover:translate-y-[1px]"
          ...
          {/* TERTIARY — subdued GitHub link with flanking lines */}
          <div className="flex items-center gap-3">
            <div className="h-px w-8 bg-[rgba(255,255,255,0.07)]" />
            <MagneticButton href="https://github.com/generalnel" strength={0.3}>
              <motion.div
                className="flex items-center gap-1.5 rounded-full px-3 py-1.5 transition-colors duration-150 hover:bg-[rgba(255,255,255,0.04)]"
                whileHover={{ scale: 1.05 }}
                transition={{ duration: 0.15 }}
              >
                <svg
                  className="h-3 w-3 text-[--color-text-muted]"
                ...
                <span
                  className="text-[10px] tracking-[0.18em] text-[--color-text-muted]"
                  style={{ fontFamily: "var(--font-mono)" }}
                >
                  github.com/generalnel
                </span>
              </motion.div>
            </MagneticButton>
            <div className="h-px w-8 bg-[rgba(255,255,255,0.07)]" />
